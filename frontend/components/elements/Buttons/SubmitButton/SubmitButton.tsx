...
export default function SubmitButton({ preText, postText, disabled, width, height, padding = "px-4 py-2", fontSize, fontweight, baseColor = "bg-DendaiTechBlue", hoverColor = "hover:bg-DendaiTechBlue/75", baseTextColor = "text-white", hoverTextColor = "text-white", borderRadius, borderWidth, borderColor, borderStyle, isLoaderRight }: SubmitButtonProps) {
    return (
